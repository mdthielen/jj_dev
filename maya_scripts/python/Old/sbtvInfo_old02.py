...
if sys.platform == 'darwin':
    ...
    keyFile = r'C:\Users\rshowalter\Documents\maya\scripts\storybots\python\sbtvKey.txt'
...
class Info():
    ...
    def __init__(self, ep, seq, shot=''):
        ...
        self.allShots = [ x for x in os.listdir(self.seqPath) if unicode(x).isnumeric()]# changed from... if 'sh_' in x ]
    ...
    def getLastAnim(self):
        ...
        for shot in self.allShots:
            ...
            for x in os.listdir(shotDir):
                ...
                else: NameError('maya directory not found in...%s\n    '%shotDir)
