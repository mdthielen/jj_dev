    ...
    for comment in edit.comments:
        ...
        if m:
            ...
            if comment_type == "LOC":
                ...
                edit._asc_sat = value
            # JJ Modify edit start
            if not edit._name and edit._clip_name:
                if not edit._clip_name.lower().endswith('wav') and not edit._clip_name.lower().endswith('png') and not edit._clip_name.lower().endswith('mov'):
                    edit._name = edit._clip_name
            # JJ Modify edit end
