...
def createLightAndLink( mesh, lightName ): #multiple meshes can be used with the syntax: ( "obj1", "obj2", "obj3" )
...
createRenderNode -allWithTexturesUp "defaultNavigation -force true -connectToExisting -source %node -destination |VRayLightDome2|VRayLightDomeShape1.domeTex" "";
...
defaultNavigation -force true -connectToExisting -source ramp1 -destination |VRayLightDome2|VRayLightDomeShape1.domeTex; window -e -vis false createRenderNodeWindow;
